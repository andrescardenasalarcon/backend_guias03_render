...
class ComputadoraDAOs {
    static obtenerComputadora(sqlConsulta, parametros, res) {
    ...
    static buscarComputadoraPorId(sqlBuscar, parametros, res) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    static crearComputadora(sqlCrear, parametros, res) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    static actualizarComputadora(sqlActualizar, parametros, res) {
        return __awaiter(this, void 0, void 0, function* () {
            yield connectionBD_1.default.task((consulta) => __awaiter(this, void 0, void 0, function* () {
...
exports.default = ComputadoraDAOs;
