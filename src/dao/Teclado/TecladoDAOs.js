...
class TecladoDAOs {
    static obtenerTeclados(sqlConsulta, parametros, res) {
    ...
    static buscarTecladoPorId(sqlBuscar, parametros, res) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    static crearTeclado(sqlCrear, parametros, res) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    static actualizarTeclado(sqlActualizar, parametros, res) {
        return __awaiter(this, void 0, void 0, function* () {
            yield connectionBD_1.default.task((consulta) => __awaiter(this, void 0, void 0, function* () {
